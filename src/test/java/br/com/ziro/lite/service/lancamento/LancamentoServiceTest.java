...
class LancamentoServiceTest {
    ...
    void salvar_comContaExistente_deveSalvarLancamento() throws ContaNaoEncontradoException {
        ...
        dto.setConta(new br.com.ziro.lite.dto.conta.ContaDTO() {{
            setId(conta.getId());
        }});
    ...
    @Test
    void atualizar_existente_deveAtualizarCampos() throws LancamentoNaoEncontradoException, ContaNaoEncontradoException {
        Lancamento lancamento = new Lancamento();
        lancamento.setId(1L);
    ...
    void montarGraficoLinhaComFiltro_deveGerarGrafico() {
        ...
        LancamentoGraficoCelulaDTO celula = new LancamentoGraficoCelulaDTO(
        ...
        var grafico = spyService.montarGraficoLinhaComFiltro(
