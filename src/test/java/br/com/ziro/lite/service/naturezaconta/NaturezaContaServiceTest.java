...
class NaturezaContaServiceTest {
    ...
    @Mock
    private NaturezaContaRepository repository;

    @Mock
    private UsuarioRepository usuarioRepository;

    @Mock
    private ContextoContaRepository contextoRepository;

    @Mock
    private UsuarioLogado usuarioLogado;

    @InjectMocks
    private NaturezaContaService service;
    ...
    @Test
    void atualizar_deveAtualizarNatureza() throws ContextoContaNaoEncontradoException, NaturezaContaNaoEncontradoException {
        NaturezaContaDTO dto = new NaturezaContaDTO();
    ...
    void inicializarValoresPadroes_deveChamarSalvarQuandoNaoExiste() throws Exception {
        ...
        when(repository.findAllByUsuarioCriacaoAndPadrao(any(), eq(true))).thenReturn(List.of(natureza));
        when(contextoRepository.findByUsuarioCriacaoAndContextoContaPadraoId(any(), any())).thenReturn(Optional.of(contexto));
