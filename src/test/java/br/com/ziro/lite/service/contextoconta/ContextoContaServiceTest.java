...
class ContextoContaServiceTest {
    ...
    @Mock
    private ContextoContaRepository repository;
    ...
    @BeforeEach
    void setUp() {
        contextoContaService = new ContextoContaService(repository, usuarioLogado, naturezaContaRepository);
    ...
    void salvar_deveSalvarContexto() {
        ...
        ContextoContaDTO request = new ContextoContaDTO(null, "Descricao", "Obs", "Codigo", usuarioDTO, null);
