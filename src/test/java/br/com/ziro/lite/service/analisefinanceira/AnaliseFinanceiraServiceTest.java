...
class AnaliseFinanceiraServiceTest {
    ...
    @Mock
    private AnaliseFinanceiraRepository repository;
    ...
    void setUp() {
        ...
        lenient().when(usuarioLogado.getCurrentDTO())
    ...
    @Test
    void buscarPorId_deveRetornarDTO_quandoEncontrar() throws AnaliseFinanceiraNaoEncontradaException {
        AnaliseFinanceira analise = new AnaliseFinanceira();
        analise.setId(1L);
    ...
    void atualizar_deveLancarExcecao_quandoNaoEncontrar() {
        ...
        assertThrows(AnaliseFinanceiraNaoEncontradaException.class,
